...
func (h *campaignHanlder) GetCampaign(c *gin.Context) {
...
func (h *campaignHanlder) CreateCampaign(c *gin.Context) {
...
func (h *campaignHanlder) UpdateCampaign(c *gin.Context) {
...
func (h *campaignHanlder) UploadImage(c *gin.Context) {
